  ...
  <div style="width: 80%">
    ...
    <el-form :inline="true" :model="form" :rules="rules" ref="ruleForm" label-width="200px">
      ...
      <el-form-item label="借书积分" prop="score">
        <el-input-number v-model="form.score" :min="10" :max="30" label="请输入所需积分"/>
      </el-form-item>
      <el-form-item label="图书数量" prop="nums">
        <el-input-number v-model="form.nums" :min="10" :max="30" label="请输入图书数量"/>
      </el-form-item>
      <br/>
